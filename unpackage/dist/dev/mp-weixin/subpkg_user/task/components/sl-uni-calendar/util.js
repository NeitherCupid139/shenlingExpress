"use strict";
const subpkg_user_task_components_slUniCalendar_calendar = require("./calendar.js");
class Calendar {
  constructor({
    date,
    selected,
  ...
  getlunar(year, month, date) {
    return subpkg_user_task_components_slUniCalendar_calendar.calendar.solar2lunar(year, month, date);
  }
  /**
   * 设置打点
   */
