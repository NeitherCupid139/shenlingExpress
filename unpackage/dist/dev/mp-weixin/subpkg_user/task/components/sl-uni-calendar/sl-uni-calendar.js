"use strict";
const subpkg_user_task_components_slUniCalendar_util = require("./util.js");
const common_vendor = require("../../../../common/vendor.js");
const subpkg_user_task_components_slUniCalendar_i18n_index = require("./i18n/index.js");
const calendarItem = () => "./sl-uni-calendar-item.js";
...
const _sfc_main = {
  ...
  created() {
    this.cale = new subpkg_user_task_components_slUniCalendar_util.Calendar({
      // date: new Date(),
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    k: common_vendor.t(($data.nowDate.year || "") + "年" + ($data.nowDate.month || "") + "月"),
    l: $props.date,
    ...
    q: common_vendor.o((...args) => $options.backtoday && $options.backtoday(...args))
  } : {}, {
    r: $props.showMonth
  }, $props.showMonth ? {
    s: common_vendor.t($data.nowDate.month)
  } : {}, {
    t: common_vendor.t($options.SUNText),
    v: common_vendor.t($options.monText),
    w: common_vendor.t($options.TUEText),
    x: common_vendor.t($options.WEDText),
    y: common_vendor.t($options.THUText),
    z: common_vendor.t($options.FRIText),
    A: common_vendor.t($options.SATText),
    B: common_vendor.f($data.weeks, (item, weekIndex, i0) => {
      return {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-a86c0c97"]]);
