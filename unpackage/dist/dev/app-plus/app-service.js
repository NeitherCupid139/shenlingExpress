  ...
  const _sfc_main$N = {
    ...
    setup(__props) {
      ...
      async function getPickUpList(page = 1, pageSize = 5) {
        ...
        if (code !== 200)
          return uni.utils.toast("获取列表失败，稍后重试！");
              ...
              vue.renderList(list.value, (item) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  ...
                  vue.createElementVNode("navigator", {
                    ...
                    vue.createElementVNode("view", { class: "header" }, [
                      vue.createElementVNode(
                        "text",
                        { class: "no" },
                        "任务编号: " + vue.toDisplayString(item.transportTaskId),
                        1
                        /* TEXT */
                      ),
                      vue.createCommentVNode(' <text class="status">已延迟</text> ')
                    ]),
                  ...
                  vue.createElementVNode("view", { class: "footer" }, [
                    vue.createElementVNode("view", { class: "label" }, "提货时间"),
                    vue.createElementVNode(
                      "view",
                      { class: "time" },
                ...
                return vue.openBlock(), vue.createElementBlock("view", {
                  ...
                  vue.createElementVNode("view", { class: "footer" }, [
                    ...
                    item.status === 2 ? (vue.openBlock(), vue.createElementBlock("navigator", {
                      ...
                      class: "action"
                    }, " 交付 ", 8, ["url"])) : vue.createCommentVNode("v-if", true),
                    item.status === 4 ? (vue.openBlock(), vue.createElementBlock("navigator", {
                      ...
                      class: "action"
                    }, "回车登记", 8, ["url"])) : vue.createCommentVNode("v-if", true)
                  ])
                ]);
              }),
              128
          ...
          [
            vue.createElementVNode("view", { class: "task-search" }, [
              vue.createElementVNode("view", { class: "filter-bar" }, [
                ...
                vue.createElementVNode("text", { class: "text" }, "至"),
                vue.createElementVNode(
                  "picker",
                  {
                    class: "picker",
            ...
            vue.createElementVNode("scroll-view", {
              ...
              vue.createElementVNode("view", { class: "scroll-view-wrapper" }, [
                ...
                list.value.length == 0 ? (vue.openBlock(), vue.createElementBlock("view", {
                  key: 1,
                  class: "task-blank"
                }, "无完成货物")) : vue.createCommentVNode("v-if", true)
              ])
            ])
          ],
          64
    ...
    setup(__props) {
      ...
      async function onFormSubmit() {
        try {
          ...
          formatAppLog("log", "at pages/login/components/account.vue:70", "验证失败：", err);
        }
      }
      return (_ctx, _cache) => {
    ...
    return vue.openBlock(), vue.createBlock(
      ...
      },
      {
        default: vue.withCtx(() => [
          ...
          vue.createElementVNode("button", { class: "submit-button" }, "登录")
        ]),
        _: 1
        /* STABLE */
      },
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "page-container" }, [
          vue.createElementVNode("view", { class: "user-profile" }, [
            ...
            vue.createElementVNode(
              "text",
              { class: "no" },
              "司机编号：" + vue.toDisplayString(userData.value.number),
              1
              /* TEXT */
            ),
            vue.createElementVNode(
              "text",
              { class: "mobile" },
              "手机号码：" + vue.toDisplayString(userData.value.phone),
              1
              /* TEXT */
            )
          ]),
          vue.createElementVNode("view", { class: "month-overview" }, [
            vue.createElementVNode("view", { class: "title" }, "我的任务"),
            vue.createElementVNode("view", { class: "content" }, [
              vue.createElementVNode("view", { class: "item" }, [
                ...
                vue.createElementVNode("text", { class: "label" }, "任务总量")
              ]),
              vue.createElementVNode("view", { class: "item" }, [
                vue.createElementVNode(
                  "text",
                ...
                vue.createElementVNode("text", { class: "label" }, "完成任务量")
              ]),
              vue.createElementVNode("view", { class: "item" }, [
                vue.createElementVNode(
                  "text",
                ...
                vue.createElementVNode("text", { class: "label" }, "运输里程(km)")
              ])
            ])
          ]),
    ...
    setup(__props) {
      ...
      async function onScrollToLower() {
        ...
        if (res.data.data.items) {
          ...
          formatAppLog("log", "at pages/message/components/notify.vue:25", "已经触底...", page);
        }
      }
      async function onScrollViewRefresh() {
        formatAppLog("log", "at pages/message/components/notify.vue:33", "下拉刷新触发...");
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "counter" }, [
          ...
          vue.createCommentVNode(" 显示仓库中的count值 "),
          vue.withDirectives(vue.createElementVNode(
            "input",
            {
              class: "input",
          ...
          vue.createElementVNode("scroll-view", {
            ...
            vue.createElementVNode("view", { class: "scroll-view-wrapper" }, [
              vue.createElementVNode("view", { class: "basic-info panel" }, [
                vue.createElementVNode("view", { class: "panel-title" }, "基本信息"),
                vue.createElementVNode("view", { class: "timeline" }, [
                  vue.createElementVNode(
                    "view",
                    { class: "line" },
                ...
                vue.createElementVNode("view", { class: "info-list" }, [
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "任务编号"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
                  ...
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "提货联系人"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
                  ...
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "预计提货时间"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
                  ...
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "实际提货时间"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
                  ...
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "交付联系人"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
                  ...
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "预计送达时间"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
                  ...
                  vue.createElementVNode("view", { class: "info-list-item" }, [
                    vue.createElementVNode("text", { class: "label" }, "实际送达时间"),
                    vue.createElementVNode(
                      "text",
                      { class: "value" },
              ...
              taskDetail.value.exceptionList && taskDetail.value.exceptionList.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
                ...
                vue.createElementVNode("view", { class: "panel-title" }, "异常信息"),
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList(taskDetail.value.exceptionList, (item) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      ...
                      vue.createElementVNode("view", { class: "info-list-item" }, [
                        vue.createElementVNode("text", { class: "label" }, "上报时间"),
                        vue.createElementVNode(
                          "text",
                          { class: "value" },
                      ...
                      vue.createElementVNode("view", { class: "info-list-item" }, [
                        vue.createElementVNode("text", { class: "label" }, "异常类型"),
                        vue.createElementVNode(
                          "text",
                          { class: "value" },
              ...
              vue.createElementVNode("view", { class: "panel pickup-info" }, [
                vue.createElementVNode("view", { class: "panel-title" }, "提货信息"),
                vue.createElementVNode("view", { class: "label" }, "提货凭证"),
                vue.createElementVNode("view", { class: "pictures" }, [
                  ...
                  !taskDetail.value.cargoPickUpPictureList ? (vue.openBlock(), vue.createElementBlock("view", {
                    key: 0,
                    class: "picture-blank"
                  }, "暂无图片")) : vue.createCommentVNode("v-if", true)
                ]),
                vue.createElementVNode("view", { class: "label" }, "货品照片"),
                vue.createElementVNode("view", { class: "pictures" }, [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
              ...
              vue.createElementVNode("view", { class: "delivery-info panel" }, [
                vue.createElementVNode("view", { class: "panel-title" }, "交货信息"),
                vue.createElementVNode("view", { class: "label" }, "交货凭证"),
                vue.createElementVNode("view", { class: "pictures" }, [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                ...
                footer: vue.withCtx(() => [
                  vue.createElementVNode("picker", {
                    ...
                    vue.createElementVNode(
                      "text",
                      null,
                      vue.toDisplayString(delayTime.value ? delayTime.value + ":00" : "不可超过2个小时"),
                      1
                      /* TEXT */
                    )
                  ], 40, ["value"])
...
详细信息：${s4}`), r3(i3);
                ...
                vue.createVNode(_component_uni_list, { class: "popup-action-sheet" }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_uni_list_item, null, {
                      header: vue.withCtx(() => [
                        vue.createElementVNode("view", { class: "header" }, "选择类型")
                      ]),
                      _: 1
                      /* STABLE */
                    }),
      ...
      vue.createElementVNode("scroll-view", {
        ...
        vue.createElementVNode("view", { class: "scroll-view-wrapper" }, [
          vue.createElementVNode("view", { class: "order-list-item" }, [
            ...
            vue.createElementVNode("text", { class: "goods-number" }, "1件"),
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "page-container" }, [
          ...
          vue.createElementVNode("cover-view", { class: "meta" }, [
            vue.createElementVNode("cover-view", { class: "label" }, "任务编号: XAHH1234567"),
            vue.createElementVNode("cover-view", { class: "timeline" }, [
              vue.createElementVNode("cover-view", { class: "start" }, "起"),
              vue.createElementVNode("cover-view", { class: "end" }, "止"),
              vue.createElementVNode("cover-view", { class: "line" }, "北京市昌平区回龙观街道西三旗桥东金燕龙写字楼8877号"),
              vue.createElementVNode("cover-view", { class: "line" }, "河南省郑州市路北区北清路99号")
            ])
          ]),
          vue.createElementVNode("cover-view", { class: "toolbar" }, [
            vue.createElementVNode("cover-view", { class: "button" }, "导航")
          ])
        ]);
      };
    }
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "vehicle-panel" }, [
          vue.createElementVNode("view", { class: "vehicle-panel-header" }, [
            vue.createElementVNode("view", { class: "label" }, "交通违章"),
            vue.createElementVNode(
              "radio-group",
              {
                class: "radio-group",
  ...
  const _sfc_main$c = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "vehicle-panel" }, [
          vue.createElementVNode("view", { class: "vehicle-panel-header" }, [
            vue.createElementVNode("view", { class: "label" }, "车辆故障"),
            vue.createElementVNode(
              "radio-group",
              {
                class: "radio-group",
  ...
  const _sfc_main$b = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "vehicle-panel" }, [
          vue.createElementVNode("view", { class: "vehicle-panel-header" }, [
            vue.createElementVNode("view", { class: "label" }, "交通事故"),
            vue.createElementVNode(
              "radio-group",
              {
                class: "radio-group",
  ...
  const _sfc_main$a = {
    ...
    setup(__props) {
      ...
      async function onFormSubmit() {
        ...
        formatAppLog("log", "at subpkg_task/record/index.vue:30", "回车登记:", res);
                      ...
                      vue.createVNode(_component_uni_datetime_picker, {
                        ...
                        default: vue.withCtx(() => [
                          vue.createElementVNode(
                            "view",
                            { class: "picker-value" },
                            vue.toDisplayString(vue.unref(taskStore).recordData.endTime || "请选择"),
                            1
                            /* TEXT */
                          )
                        ]),
  ...
  const _sfc_main$8 = {
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        const _component_uni_list = resolveEasycom(vue.resolveDynamicComponent("uni-list"), __easycom_1$2);
        return vue.openBlock(), vue.createElementBlock("view", { class: "page-container" }, [
          vue.createCommentVNode(" 1. 汽车图片轮播图组件 "),
  ...
  const _sfc_main$4 = {
    ...
    setup(__props) {
      function onClearCache() {
        formatAppLog("log", "at subpkg_user/settings/index.vue:9", "清理缓存");
        uni.clearStorage();
        uni.utils.toast("清理缓存成功", "success");
      }
      function logOut() {
        formatAppLog("log", "at subpkg_user/settings/index.vue:21", "退出登录");
        uni.clearStorage();
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "bind-mobile" }, [
          vue.createVNode(_component_uni_forms, {
            ...
            default: vue.withCtx(() => [
              ...
              vue.createElementVNode("button", { class: "submit-button" }, "下一步")
            ]),
            _: 1
            /* STABLE */
          }, 8, ["modelValue"])
          ...
          vue.createVNode(
            ...
            },
            {
              default: vue.withCtx(() => [
                ...
                vue.createElementVNode("button", { class: "submit-button" }, "确定修改")
              ]),
              _: 1
              /* STABLE */
            },
  ...
  function _sfc_render(_ctx, _cache) {
    ...
    const _component_uni_list = resolveEasycom(vue.resolveDynamicComponent("uni-list"), __easycom_1$2);
    return vue.openBlock(), vue.createElementBlock("view", { class: "page-container" }, [
      vue.createElementVNode("view", { class: "tips" }, "开启后，有新的任务通知你"),
      vue.createVNode(_component_uni_list, { border: false }, {
        default: vue.withCtx(() => [
          vue.createVNode(_component_uni_list_item, { title: "允许给我推送任务通知" }, {
            footer: vue.withCtx(() => [
              vue.createElementVNode(
                "switch",
                {
